...
const FEATURES = [
  {
    ...
    description:
      "Crea, edita y elimina tus eventos. Filtra por categoría, precio, modalidad y fecha. Paginación de 15 por página.",
  },
  {
    number: "02",
    iconLabel: "TK",
    ...
    description:
      "Genera tickets al inscribirte. Pasarela Stripe para eventos de pago. Historial de asistencias en tu perfil.",
  },
  {
    number: "03",
    iconLabel: "ID",
    ...
    description:
      "Gestiona nombre, avatar y credenciales. Spring Security + JWT. Visualiza tus eventos creados.",
  },
  {
    number: "04",
    iconLabel: "NET",
    ...
    description:
      "Consulta quién asiste a cada evento. Conecta con la comunidad tecnológica global. Colabora e innova.",
  },
];
